...
async def main():
    ...
    api_id = int(os.getenv("TELEGRAM_API_ID", "29226749"))  # Replace with your API ID
    api_hash = os.getenv("TELEGRAM_API_HASH", "d28f558dce14148b20ddcad52e249c7f")  # Replace with your API Hash
